...
- [RStudio Hat](https://rstudio.com/resources/cheatsheets/) Türkçe R Markdown cheatsheet var.
...
.sub-topic-note[RMarkdown ailesi]
...
Örnek: [https://www.rladiesirvine.org/](https://www.rladiesirvine.org/)
<hr>

Kaynak kodu: https://github.com/rladies-irvine/rladies-irvine.github.io
...
https://mdogucu.ics.uci.edu/teaching/workshops/2020-03-05-intro-tidy/info.html
...
.left-panel[
```{r eval = FALSE}
knitr::include_graphics('img/hex-blogdown.png')
```
]
.right-panel[

- Blog veya genel olarak internet sitesi yapımı
- `blogdown::new_site()` otomatik olarak yenı web sistesi oluşturur.
- `blogdown::new_site(theme)` otomatik olarak yenı web sistesi oluşturur.
]
